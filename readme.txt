...
This plugin was created for bands/performers who do one off shows lasting a couple of hours rather than a few days.  This plugin does not use custom post types, so you can't asign categories or tags to events.  Also there are no automatic pages created for them (you would have to do this manually).
...
For advanced users, you can show just upcoming,past or all events and change the ordering by using the following shortcode "[hc_rse_events showevents="[daterange|daterange-reverse|upcoming|upcoming-reverse|past|past-reverse|all|all-reverse]".
...
Check the Help/Usage page in the admin menu for the this plugin for more details and examples.
...
= 1.5.3 =
* New: Date range feature. See help/useage page for details

<div class="wrap">
	...
	<ul>
        <li><strong>daterange</strong> - <?php _e( 'Show dates inbetween the startdate and enddate attributes.  NOTE THESE MUST BE IN THE FORMAT yyyy-mm-dd.' , 'hc_rse' ); ?></li>
        <li><strong>daterange</strong> - <?php _e( 'Same as above, usefull for listing past events.' , 'hc_rse' ); ?></li>
    ...
    <p><?php _e( 'To show all events in 2010 use short code' , 'hc_rse' ); ?>: <strong>[hc_rse_events showevents='daterange' startdate='2010-01-01' enddate='2011-01-01']</strong></p>
